...
var viewport = {
    ...
    init: function() {
        ...
        this.mesh.rotation.x = -constant.ETA;
...
var lights = {
    ...
    init: function() {
        ...
        viewport.mesh.add(this.ambientLight);
        viewport.mesh.add(this.light1);
        viewport.mesh.add(this.light2);
        //viewport.mesh.add( rectLightHelper );
        viewport.mesh.add(this.light3);
        viewport.mesh.add(this.light4);
        if (this.extralights) {
            viewport.mesh.add(this.light5);
            viewport.mesh.add(this.light6);
            viewport.mesh.add(this.light7);
            viewport.mesh.add(this.light8);
        }
    }
};
...
var field = {
    ...
    init: function() {
        ...
        viewport.mesh.add(borderMeshBack);
        ...
        viewport.mesh.add(borderMeshFront);
        ...
        viewport.mesh.add(borderMeshLeft);
        ...
        viewport.mesh.add(borderMeshRight);
        ...
        viewport.mesh.add(goalMeshLeft);
        ...
        viewport.mesh.add(goalMeshRight);
...
var car = {
    ...
    create: function(team, xpos, ypos, rot) {
        ...
        viewport.mesh.add(this.meshes[this.count]);
